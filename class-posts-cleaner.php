<?php
class Post_Cleaner extends WP_CLI_Scripts_Migration_Base {
	public function __construct() {
		// add the filters
		add_filter( 'clean_post_content', array( 'Post_Cleaner', 'strip_inline_styles' ), 10, 1 );
		add_filter( 'clean_post_content', array( 'Post_Cleaner', 'strip_script_tags' ), 20, 1 );
		add_filter( 'clean_post_content', array( 'Post_Cleaner', 'convert_smart_quotes' ), 30, 1 );
		//add_filter( 'clean_post_content', array( 'Post_Cleaner', 'remove_empty_tags' ), 40, 1 );
		add_filter( 'clean_post_content', array( 'Post_Cleaner', 'close_unclosed_tags' ), 40, 1 );
	}
